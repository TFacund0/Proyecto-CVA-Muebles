...
$routes->post('/admin/galeria/aprobar/(:num)', 'GaleriaController::aprobar/$1', ['filter' => 'auth']);
$routes->post('/admin/galeria/eliminar/(:num)', 'GaleriaController::eliminar/$1', ['filter' => 'auth']);
...
$routes->post('/editar-usuario/(:num)', 'UsuarioController::editar_usuario/$1', ['filter' => 'auth']);
$routes->post('/delete-usuario/(:num)', 'UsuarioController::delete_usuario/$1', ['filter' => 'auth']);
$routes->post('/activar-usuario/(:num)', 'UsuarioController::activar_usuario/$1', ['filter' => 'auth']);
...
$routes->post('/delete-producto/(:num)', 'ProductoController::delete_producto/$1', ['filter' => 'auth']);
$routes->post('/activar-producto/(:num)', 'ProductoController::activar_producto/$1', ['filter' => 'auth']);
...
$routes->post('/admin/productos/subir-fotos/(:num)', 'ProductoController::subir_fotos_galeria/$1', ['filter' => 'auth']);
$routes->post('/admin/productos/eliminar-foto/(:num)', 'ProductoController::eliminar_foto_galeria/$1', ['filter' => 'auth']);
...
$routes->post('/admin/categorias/eliminar/(:num)', 'CategoriaController::eliminar/$1', ['filter' => 'auth']);
$routes->post('/admin/categorias/toggle/(:num)', 'CategoriaController::toggle/$1', ['filter' => 'auth']);
...
$routes->post('carrito_suma/(:any)', 'CarritoController::suma/$1', ['filter' => 'auth']);
$routes->post('carrito_resta/(:any)', 'CarritoController::resta/$1', ['filter' => 'auth']);
