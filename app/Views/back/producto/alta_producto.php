<div class="container my-5 w-50 p-5" id="alta-producto-contenedor">
    <h3 class="text-center mb-3 titulo-form-alta-producto">Formulario de Alta de producto</h3>
        ...
        <form method="post" action="<?php echo base_url('/enviar-alta-producto') ?>">
            <div class="mb-3">
                <label for="producto-form-alta" class="form-label">Nombre del Producto</label>
                <input type="text" name="nombre_producto" class="form-control" id="producto-form-alta" placeholder="Ingrese el nombre del producto">
            </div>
            ...
            <div class="row">
                <div class="col-6 mb-3">
                    ...
                    <input type="number" name="precio" class="form-control" id="precio-form-alta" placeholder="Ingrese el precio del producto">
                </div>

                <div class="col-6 mb-3">
                    <label for="precio-vta-form-alta" class="form-label">Precio venta</label>
                    <input type="number" name="precio-vta" class="form-control" id="precio-vta-form-alta" placeholder="Ingrese el precio de venta">
                </div>
                ...
                <div class="col-6 mb-3">
                    ...
                    <input type="number" name="stock" class="form-control" id="stock-form-alta" placeholder="Ingrese el stock del producto   ">
                </div>

                <div class="col-6 mb-3">
                    <label for="stock-min-form-alta" class="form-label">Stock Mínimo</label>
                    <input type="number" name="stock-min" class="form-control" id="stock-min-form-alta" placeholder="Ingrese el stock mínimo">
                </div>
