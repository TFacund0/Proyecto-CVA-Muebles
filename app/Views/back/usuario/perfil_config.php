...
<div class="profile-config-wrapper py-4">
    <div class="container">
        ...
        <!-- SECCIÓN: SEGURIDAD Y ESTADÍSTICAS -->
                ...
                <div class="card border-0 shadow-sm rounded-4 h-100">
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex align-items-center justify-content-between p-3 bg-artisan-soft rounded-3 mb-3 border">
                            ...
                            <button class="btn btn-sm btn-artisan-dark rounded-pill px-3" data-bs-toggle="modal" data-bs-target="#modalPassword">Actualizar</button>
                        </div>
                        <p class="x-small text-muted"><i class="bi bi-info-circle me-1"></i> Te recomendamos cambiar tu clave periódicamente para mantener el taller seguro.</p>
                    </div>
                </div>
            </div>

            <!-- Resumen de Gestión (Solo Admin) -->
            <?php if($profile == 1): ?>
            <div class="col-md-7">
                <div class="card border-0 shadow-sm rounded-4 h-100">
                    <div class="card-body p-4">
