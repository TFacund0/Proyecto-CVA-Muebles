...
<?= $this->section('extra-css') ?>
    <link rel="stylesheet" href="<?= base_url('assets/css/pages/auth/login.css?v=1.2')?>">
<?= $this->endSection() ?>
    ...
    <div class="login-container rounded p-5">
        <div class="row">
            ...
            <div class="col-md-6 d-flex flex-column align-items-center justify-content-center text-center p-4">
                <!-- Icono de usuario -->
                <img src="<?= base_url('assets/img/ui/icons/registro.svg') ?>" alt="icono-usuario" style="width: 150px;">
