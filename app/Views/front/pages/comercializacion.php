<body>
    ...
    <header class="comercializacion-header titulo-seccion">
    ...
    <section class="container" id="container-comercializacion">
        ...
        <div class="row my-3 p-3 contenedor-seccion g-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="card-style text-center p-3 h-100">
                                <i class="fas fa-money-bill-wave icono-pago"></i>
                        ...
                        <div class="col-md-6">
                            <div class="card-style text-center p-3 h-100">
                                <i class="fas fa-credit-card icono-pago"></i>
                        ...
                        <div class="col-md-6">
                            <div class="card-style text-center p-3 h-100">
                                <i class="fas fa-hand-holding-usd icono-pago"></i>
            ...
            <div class="col-md-6">
                <div class="card-style h-100 p-4">
                    <h3 class="text-center mb-4">Envíos y Entregas</h3>
        ...
        <div class="row my-3 p-3 contenedor-seccion g-4">
            ...
            <div class="col-md-6">
                <div class="card-style h-100 p-4">
                    <h3 class="text-center mb-4">Cobertura de Envíos</h3>
                    <ul class="ps-3 mb-4">
                    ...
                    <div class="text-center">
                        <a href="<?= base_url('informacionContacto')?>" class="btn boton-seccion">Consultas envio y costo</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card-style h-100 p-4">
                    <h3 class="text-center mb-4">Retiro en Taller</h3>
                    ...
                    <div class="text-center">
                        <a href="<?= base_url('informacionContacto')?>" class="btn boton-seccion">Coordinar retiro</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row my-3 p-3 contenedor-seccion">
            <div class="col-12">
                <div class="card-style p-4 text-center">
                    <h3 class="mb-4">Garantía y Soporte</h3>
                    ...
                    <a href="<?= base_url('terminosYCondiciones') ?>" class="enlace-seccion">Ver términos de garantía completos</a>
                </div>
            </div>
        </div>
    </section>
