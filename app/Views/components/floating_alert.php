...
<?php if ($msg): ?>
    <div class="toast-container position-fixed bottom-0 end-0 p-4" style="z-index: 9999;">
        <div id="liveToast" class="toast show border-0 rounded-4 shadow-lg animate-slide-up" role="alert" aria-live="assertive" aria-atomic="true">
            ...
            <div class="toast-body bg-white py-3 px-4 rounded-bottom-4 border-top" style="border-top: 1px dashed #eee !important;">
                <p class="mb-0 text-muted fw-500"><?= $msg ?></p>
            </div>
    ...
    <style>
        ...
        .toast-progress-bar {
            ...
            animation: progressToast 4s linear forwards;
        }
